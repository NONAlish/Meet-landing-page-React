    ...
    <div>
      ...
      <main>
        <div className="first_block">
          <img src="src/assets/desktop/image-hero-left.png" alt="image-hero-left" />
          <div className="main_text">
            <h1>Group Chat for Everyone</h1>
            <p>Meet makes it easy to connect with others face-to-face virtually and collaborate across any device.</p>
            <div className="btn">
              <button className="download_btn">Download <span>v1.3</span></button>
              <button className="what_btn">What is it?</button>
            </div>
          </div>
          <img src="src/assets/desktop/image-hero-right.png" alt="image-hero-right" />
        </div>
        ...
        <div className="photos">
          <img src="src/assets/desktop/image-woman-in-videocall.jpg" alt="woman-in-videocall" />
          <img src="src/assets/desktop/image-women-videochatting.jpg" alt="women-videochatting" />
          <img src="src/assets/desktop/image-men-in-meeting.jpg" alt="men-in-meeting" />
          <img src="src/assets/desktop/image-man-texting.jpg" alt="man-texting" />
        </div>
        <div className="explanation">
          <h3>Built for modern use</h3>
          <h2>Smarter meetings, all in one place</h2>
          <h4>Send messages, share files, show your screen, and record your meetings — all in one workspace. Control who can join with invite-only team access, data encryption, and data export.</h4>
        </div>
      ...
      <footer>
        <div></div>
          ...
          <h5>Stay connected with reliable HD meetings and unlimited one-on-one and group video sessions.</h5>
          <button className="download_btn_perple">Download <span>v1.3</span></button>
      </footer>
    </div>
  );
}
